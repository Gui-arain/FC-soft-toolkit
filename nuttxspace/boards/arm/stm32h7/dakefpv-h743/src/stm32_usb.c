/****************************************************************************
 * boards/arm/stm32h7/dakefpv-h743/src/stm32_usb.c
 *
...
#ifndef CONFIG_DAKEFPV_H743_USBHOST_PRIO
#  define CONFIG_DAKEFPV_H743_USBHOST_PRIO 100
#endif

#ifndef CONFIG_DAKEFPV_H743_USBHOST_STACKSIZE
#  define CONFIG_DAKEFPV_H743_USBHOST_STACKSIZE 2048
#endif
  ...
  if (g_usbconn)
    {
      ...
      ret = kthread_create("usbhost", CONFIG_DAKEFPV_H743_USBHOST_PRIO,
                           CONFIG_DAKEFPV_H743_USBHOST_STACKSIZE,
                           usbhost_waiter, NULL);
