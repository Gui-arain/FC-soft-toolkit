...
#define ICM42688P_IOC_SET_GYRO_DNF_FREQ   _SNIOC(0x00B3)
...
#define ICM42688P_IOC_SET_GYRO_OFFSET     _SNIOC(0x00B8)
#define ICM42688P_IOC_SET_ACCEL_OFFSET    _SNIOC(0x00B9)

/* Enable/disable the gyro digital notch filter (DNF).  Arg: bool (0=off, 1=on) */

#define ICM42688P_IOC_SET_GYRO_DNF_EN     _SNIOC(0x00BA)

/* Enable/disable the accel anti-aliasing filter (AAF).  Arg: bool (0=off, 1=on) */

#define ICM42688P_IOC_SET_ACCEL_AAF_EN    _SNIOC(0x00BB)

/* Set per-axis gyro notch filter center frequency.  Arg: uint32_t Hz */

#define ICM42688P_IOC_SET_GYRO_DNF_FREQ_X _SNIOC(0x00BC)
#define ICM42688P_IOC_SET_GYRO_DNF_FREQ_Y _SNIOC(0x00BD)
#define ICM42688P_IOC_SET_GYRO_DNF_FREQ_Z _SNIOC(0x00BE)

/* Set gyro UI filter order.  Arg: uint8_t (1/2/3) */

#define ICM42688P_IOC_SET_GYRO_UI_FILT_ORD  _SNIOC(0x00BF)

/* Set accel UI filter order.  Arg: uint8_t (1/2/3) */

#define ICM42688P_IOC_SET_ACCEL_UI_FILT_ORD _SNIOC(0x00C0)

/* Set gyro UI filter bandwidth selector.  Arg: uint8_t (register GYRO_ACCEL_CONFIG0 value) */

#define ICM42688P_IOC_SET_GYRO_UI_FILT_BW   _SNIOC(0x00C1)

/* Set accel UI filter bandwidth selector.  Arg: uint8_t (register GYRO_ACCEL_CONFIG0 value) */

#define ICM42688P_IOC_SET_ACCEL_UI_FILT_BW  _SNIOC(0x00C2)
